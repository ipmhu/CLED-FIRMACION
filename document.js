...
async function loadSignedDocument() {
    ...
    if (
        ...
        console.warn(
            "No existen los elementos del documento firmado en HTML."
        );
    ...
    try {
        ...
        if (error) {
            ...
            console.error(
                "Error obteniendo documento firmado:",
                error
            );
